...
from ...data.loader import get_dataset, get_test_dataset
...
def run_sft(
    ...
    if training_args.do_predict:
        ...
        trainer.save_predictions(predict_results, text_dataset=text_dataset,
                                 sentence_num=gen_kwargs["num_return_sequences"])
